window.onload = () => {
	...
	// youtube
        ...
        // trader
        $("h2#trader").text('Auto-Trade Platformu:');   
        $("h2#trader").after('<ul id="trader-list"></ul>');   
        blockchainResources.trader.forEach(element => {
            $("ul#trader-list").append('<li><a href="' + element.url + '">' + element.title + '</a></li>');
        });
