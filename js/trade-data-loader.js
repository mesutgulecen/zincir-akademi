window.onload = () => {
	...
	// youtube
        ...
        // autot
        $("h2#autot").text('Auto-Trade Platformu:');   
        $("h2#autot").after('<ul id="autot-list"></ul>');   
        blockchainResources.autot.forEach(element => {
            $("ul#autot-list").append('<li><a href="' + element.url + '">' + element.title + '</a></li>');
        });
